...
public abstract class Produto {
	...
	*/
	public static Produto criarDoTexto(String linha){
		...
		Double precoDeCusto = Double.valueOf(dados[2]);
		Double margemDeLucro = Double.valueOf(dados[3]);
		...
		if (tipo == 1){
			...
			novoProduto = new ProdutoPerecivel(descricao, precoDeCusto,margemDeLucro, validade);
		}
